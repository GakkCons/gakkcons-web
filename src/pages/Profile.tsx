...
function Profile() {
  ...
  const filteredRequests =
    data?.filter((request: any) => request.status === "Confirmed") || [];

  const handleUpdateProfile = () => {
    axios
      .put("/users/profile/update", profiledata, {
        headers: {
          Authorization: `Bearer ${token}`, // Use the actual token here
        },
      })
    ...
    <>
      ...
      <div className="mx-2 sm:mx-4 md:mx-10 details mt-4 mb-2 ">
        <div className="grid grid-cols-1 md:grid-cols-12 lg:grid-cols-12 gap-4">
          ...
          <div
            className="col-span-1 md:col-span-8 lg:col-span-9  pb-10 px-5 relative"
            style={{
              maxWidth: "100%",
              width: "100vw",
          ...
          >
            <div
              className="text-center mx-10 my-6 pt-5 sm:pt-5 lg:pt-0 xl:pt-0 md:pt-5 lg:absolute xl:absolute consultationmode"
              style={{ right: 0 }}
            >
            ...
            {isEdit ? (
              <div className="flex justify-center px-4">
                <div className="w-full max-w-md sm:max-w-lg md:max-w-xl lg:max-w-2xl min-h-[200px] mt-6 rounded-md p-4 bg-[#282726]">
                  ...
                  <div className="flex justify-center ">
                    <button
                      className="text-white px-10 py-2 text-md font-bold tracking-wide rounded-md"
                      style={{ background: "rgba(27, 108, 30, 1)" }}
                      onClick={() => {
                        setShowUpdateModal(true);
                      }}
                    >
              ...
              <div
                className="w-full min-h-[700px]  rounded-md px-5 "
                style={{ background: "rgba(40, 39, 38, 1)" }}
              >
                <div className="flex justify-between items-center py-2">
                  <h1 className="text-white font-bold w-1 ">
                ...
                <div
                  ...
                  style={{ background: "rgba(209, 200, 195, 1)" }}
                >
